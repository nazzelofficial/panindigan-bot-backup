...
importers:
  ...
  .:
    dependencies:
      ...
      '@discordjs/voice':
        specifier: ^0.19.2
        version: 0.19.2(@emnapi/core@1.11.3)(@emnapi/runtime@1.11.3)
      ...
      '@prisma/client':
        specifier: ^7.9.1
        version: 7.9.1(prisma@7.9.1(@types/react@19.2.17)(react-dom@19.2.8(react@19.2.8))(react@19.2.8)(typescript@6.0.3))(typescript@6.0.3)
    ...
    devDependencies:
      ...
      prisma:
        specifier: ^7.9.1
        version: 7.9.1(@types/react@19.2.17)(react-dom@19.2.8(react@19.2.8))(react@19.2.8)(typescript@6.0.3)
      tsx:
        specifier: ^4.23.1
        version: 4.23.1
      typescript:
...
packages:
  ...
  '@sapphire/cron@1.2.1':
    resolution: {integrity: sha512-K96GX4UkzgC/Y2VHXVjhM2Bl4D04552nr/fDiOj9bOACW1+wqeFfLJ3eV6jleTSXmzPIwDvkPIUJLf8A5KSD+w==}
    engines: {node: '>=v14.0.0', npm: '>=7.0.0'}

  '@sapphire/discord-utilities@3.5.0':
    resolution: {integrity: sha512-H4SY5KTVDZrqA5QG7ob6etwqhdOb3TRSY2wv56f0tiobUdIr0irlrYvdmr8Kg/FRxWU+aiHDIISWGG5vBuxOGw==}
    engines: {node: '>=v14.0.0', npm: '>=7.0.0'}

  '@sapphire/discord.js-utilities@7.3.3':
    resolution: {integrity: sha512-WDj+zjWgNCUSvzYDD0wY3TVeTUseHq0Nhk0wVWxSDjY8z2gFEVcpY7wF8/fbTDWP44LUG5sUQ4haIrIj2OjmkQ==}
    engines: {node: '>=16.6.0', npm: '>=7.0.0'}

  '@sapphire/duration@1.2.0':
    resolution: {integrity: sha512-LxjOAFXz81WmrI8XX9YaVcAZDjQj/1p78lZCvkAWZB1nphOwz/D0dU3CBejmhOWx5dO5CszTkLJMNR0xuCK+Zg==}
    engines: {node: '>=v14.0.0', npm: '>=7.0.0'}

  '@sapphire/plugin-logger@4.1.0':
    resolution: {integrity: sha512-+vLTITQw3DI8+kfDPNJ0yhIK/LrfM/Gro/UFcxgYWLLm+lwNmSpLZxdWe9v7ESXprody7rTp8JXPNBK7UWyE8w==}
  ...
  '@sapphire/time-utilities@1.7.14':
    resolution: {integrity: sha512-UVJQ9oyzXcmJVVf9Y9ucGzRmKoPxe6SehpQlBNTX7CTVu0aj1lrEGL+bBa0Mu7hxF5DYXYjDYeO1e5BR0eg90Q==}
    engines: {node: '>=v14.0.0', npm: '>=7.0.0'}

  '@sapphire/timer-manager@1.0.4':
    resolution: {integrity: sha512-gc1JW8oui86f2l0T/1Iwd7hZTgus8b46slitTR2y0+wiMAEYxdp6vVTHvMAEHOqX8drkxK70aGfZmQKbAcgFqQ==}
    engines: {node: '>=v14.0.0', npm: '>=7.0.0'}

  '@sapphire/timestamp@1.0.5':
    resolution: {integrity: sha512-oNwWyNdbt5wm4aYZvlHl1+64U3g0xrFmRIHsnER7RgMxNnp/wmAE4yTK2oUHeadg3t4V9iYctPAQCF+aINke4g==}
    engines: {node: '>=v14.0.0', npm: '>=7.0.0'}
  ...
  groq-sdk@1.4.1:
    resolution: {integrity: sha512-M/SmQdHy+nI4ZWyDgXK57p+jQHi9ojjzJVv3mlkDAL/vvxduUYoyAzib70dNvxsWmwsyZTSERMrXgaXR3B3KUA==}
    hasBin: true
  ...
  pm2@7.0.3:
    resolution: {integrity: sha512-zRJOdburpb9OEPB0uqoNT8C1Gp7hPJPVy4Kr67XJNuT9UlMQcOt1WXrYQUmwqKPHk8FyauvP1CPhqoCrCaPw0Q==}
    engines: {node: '>=18.0.0'}
    hasBin: true
...
snapshots:
  ...
  '@discordjs/voice@0.19.2(@emnapi/core@1.11.3)(@emnapi/runtime@1.11.3)':
    dependencies:
  ...
  '@prisma/client@7.9.1(prisma@7.9.1(@types/react@19.2.17)(react-dom@19.2.8(react@19.2.8))(react@19.2.8)(typescript@6.0.3))(typescript@6.0.3)':
    dependencies:
      '@prisma/client-runtime-utils': 7.9.1
    optionalDependencies:
      prisma: 7.9.1(@types/react@19.2.17)(react-dom@19.2.8(react@19.2.8))(react@19.2.8)(typescript@6.0.3)
      typescript: 6.0.3
