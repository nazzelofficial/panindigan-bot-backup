...
export async function createGiveaway(data: GiveawayData): Promise<string> {
...
export async function endGiveaway(giveawayId: string): Promise<string[]> {
  const prisma = getPrismaClient();
...
export async function getGiveawayEntries(giveawayId: string): Promise<any[]> {
  const prisma = getPrismaClient();
