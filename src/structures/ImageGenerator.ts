...
export class ImageGenerator {
  private static async fetchImage(url: string): Promise<any> {
    try {
  ...
  public static async generateRankCard(options: RankCardOptions): Promise<Buffer> {
  ...
  public static async generateWelcomeCard(options: WelcomeCardOptions): Promise<Buffer> {
  ...
  public static async generateWantedPoster(username: string, avatarUrl: string): Promise<Buffer> {
  ...
  public static async generateCertificate(username: string, title: string, description?: string): Promise<Buffer> {
    ...
    ctx.lineWidth = 2;
    ctx.beginPath();
    ctx.moveTo(100, 210); ctx.lineTo(800, 210);
    ctx.stroke();
