...
export class NomCommand extends BaseCommand {
  constructor() {
    super({ name: 'nom', description: 'Nom on someone! 😋', category: 'social', premiumTier: 'free', cooldown: 3, guildOnly: false, slashCommand: true, prefixCommand: true, aliases: ['eat', 'bite', 'munch'], examples: ['/nom @user', 'p!nom @user'] } as CommandOptions);
  }
