...
export class InvertCommand extends BaseCommand {
  constructor() {
    super({ name: 'invert', description: 'Invert the colors of a user\'s avatar', category: 'image', premiumTier: 'free', cooldown: 5, guildOnly: false, slashCommand: true, prefixCommand: true, aliases: ['negative', 'invertcolors'], examples: ['/invert @user', 'p!invert @user'] } as CommandOptions);
  }
