...
export class UserWarnCommand extends BaseCommand {
  ...
  public buildSlashCommand(): SlashCommandBuilder {
    return new SlashCommandBuilder()
      ...
      .addStringOption(o => o.setName('reason').setDescription('Warning reason').setRequired(true)) as SlashCommandBuilder;
  }

  private async issueWarn(userId: string, reason: string, issuedBy: string): Promise<number> {
