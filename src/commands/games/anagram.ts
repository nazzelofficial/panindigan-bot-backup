...
export class AnagramCommand extends BaseCommand {
  constructor() {
    const options: CommandOptions = {
      name: 'anagram',
      description: 'Solve an anagram',
      category: 'games',
      cooldown: 10,
      userPermissions: [],
      botPermissions: [],
      ...
      prefixCommand: true,
      aliases: ['wordanagram'],
      examples: ['/anagram', 'p!anagram'],
    };
    super(options);
  }

  private words = ['listen', 'silent', 'enlist', 'tinsel', 'triangle', 'integral', 'alert', 'alter', 'later', 'art', 'rat', 'tar', 'eat', 'ate', 'tea', 'race', 'care', 'acre'];
  ...
  public async executeSlash(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    const embed = new EmbedBuilder()
      .setTitle(`${EMOJIS.games} Anagram`)
      .setColor(COLORS.info)
      .setDescription(`Unscramble this word: \`${anagram}\`\nYou have ${maxAttempts} attempts.`)
      .setTimestamp();
