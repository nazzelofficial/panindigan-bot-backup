...
export class ChessCommand extends BaseCommand {
  ...
  public buildSlashCommand(): SlashCommandBuilder {
    return new SlashCommandBuilder()
      ...
      .addUserOption(o => o.setName('opponent').setDescription('User to challenge').setRequired(true)) as SlashCommandBuilder;
  }
  ...
  public async executeSlash(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    const challengeEmbed = new EmbedBuilder()
      ...
      .addFields(
        { name: '🎯 How it works', value: 'Both players guess the best chess move. First to answer correctly wins!', inline: false },
        { name: '⚔️ Players', value: `⬜ **${interaction.user.username}** (Challenger)\n⬛ **${opponent.username}** (Challenged)`, inline: false }
      )
