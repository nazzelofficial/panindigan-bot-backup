...
export class CharcountCommand extends BaseCommand {
  ...
  public buildSlashCommand(): SlashCommandBuilder {
    return new SlashCommandBuilder()
      ...
      .addStringOption(opt =>
        opt.setName('text').setDescription('Text to analyse').setRequired(false)
      ) as SlashCommandBuilder;
  }

  private analyse(text: string): EmbedBuilder {
    ...
    return new EmbedBuilder()
      ...
      .addFields(
        { name: 'Characters (with spaces)', value: `\`${chars}\``, inline: true },
        { name: 'Characters (no spaces)', value: `\`${charsNoSpaces}\``, inline: true },
