...
export class OwnerHelpCommand extends BaseCommand {
  constructor() {
    super({ name: 'helpowner', description: 'View all owner-only commands (access check required) 🔑', category: 'help', premiumTier: 'free', cooldown: 5, guildOnly: false, slashCommand: true, prefixCommand: true, ownerOnly: false, aliases: ['ownerhelp', 'ownercmds'], examples: ['/helpowner', 'p!help owner'] } as CommandOptions);
  }
