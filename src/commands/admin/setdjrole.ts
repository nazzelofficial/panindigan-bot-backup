...
export class SetDjRoleCommand extends BaseCommand {
  constructor() {
    const options: CommandOptions = {
      ...
      examples: ['/setdjrole @DJ', 'p!setdjrole @DJ'],
    };
    super(options);
  }
  ...
  public async executeSlash(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    const embed = new EmbedBuilder()
      .setTitle(`${EMOJIS.success} DJ Role Set`)
...
export default SetDjRoleCommand;
