...
export const MESSAGES = {
    ...
    rateLimit: (seconds) => `🚫 Rate limit exceeded. Try again in **${seconds}s**.`,
    // Error Messages
    genericError: 'Something went wrong. Please try again later.',
    notFound: (resource) => `The **${resource}** you requested could not be found.`,
    // Success Messages
...
export function buildLoadingBar(step, total) {
