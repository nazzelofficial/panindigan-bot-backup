...
export class ModerationCommand extends BaseCommand {
    ...
    async executeSlash(i) {
        ...
        if (subcommandGroup === 'user') {
            switch (subcommand) {
                case 'ban':
                    await this.handleBan(i);
                    break;
                case 'kick':
                    await this.handleKick(i);
                    break;
                case 'mute':
                    await this.handleMute(i);
                    break;
                case 'unmute':
                    await this.handleUnmute(i);
                    break;
                case 'timeout':
                    await this.handleTimeout(i);
                    break;
                case 'warn':
                    await this.handleWarn(i);
                    break;
                case 'unban':
                    await this.handleUnban(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'lock':
                    await this.handleLock(i);
                    break;
                case 'unlock':
                    await this.handleUnlock(i);
                    break;
                case 'slowmode':
                    await this.handleSlowmode(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'add':
                    await this.handleRoleAdd(i);
                    break;
                case 'remove':
                    await this.handleRoleRemove(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'purge':
                    await this.handlePurge(i);
                    break;
                case 'purgeuser':
                    await this.handlePurgeUser(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'warnings':
                    await this.handleWarnings(i);
                    break;
                case 'history':
                    await this.handleHistory(i);
                    break;
                case 'banlist':
                    await this.handleBanlist(i);
                    break;
                case 'auditlog':
                    await this.handleAuditlog(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'automod':
                    await this.handleAutomod(i);
                    break;
                case 'raidmode':
                    await this.handleRaidmode(i);
                    break;
                case 'filter':
                    await this.handleFilter(i);
                    break;
                default:
