...
export class StarboardUnlockCommand extends BaseCommand {
    constructor() {
        super({ name: 'starboard-unlock', description: 'Unlock the starboard to allow new entries', category: 'starboard', premiumTier: 'free', cooldown: 5, guildOnly: true, slashCommand: true, prefixCommand: true, userPermissions: [PermissionFlagsBits.ManageGuild], aliases: ['sb-unlock', 'sbunlock'], examples: ['/starboard-unlock'] });
    }
