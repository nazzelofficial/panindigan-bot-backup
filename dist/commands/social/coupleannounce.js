...
export class CoupleAnnounceCommand extends BaseCommand {
    constructor() {
        super({ name: 'coupleannounce', description: 'Publish a couple or anniversary announcement with advanced formatting 📢', category: 'social', premiumTier: 'gold', cooldown: 30, guildOnly: true, slashCommand: true, prefixCommand: true, aliases: ['announcecouple', 'loveannounce'], examples: ['/coupleannounce', 'p!coupleannounce'] });
    }
    buildSlashCommand() {
    ...
    async handle(userId, guildId, type, customMsg, send, channel) {
