...
export class DedicateSongCommand extends BaseCommand {
    ...
    buildSlashCommand() {
        return (new SlashCommandBuilder()
            ...
            .addUserOption(o => o.setName('user').setDescription('Who to dedicate the song to').setRequired(true))
            .addStringOption(o => o.setName('song').setDescription('Song name and artist (e.g. "Perfect" by Ed Sheeran)').setRequired(true))
            .addStringOption(o => o.setName('message').setDescription('Add a personal message (optional)').setRequired(false))
    ...
    async executeSlash(i) {
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`${i.user.toString()} dedicates a song to ${target.toString()}! 🎶\n\n` +
                `🎼 **Song:** ${song}\n\n` +
    ...
    async executePrefix(m, _args) {
        try {
            ...
            const embed = new EmbedBuilder()
                .setTitle('🎵 Song Dedication 💕')
                .setDescription(`${m.author.toString()} dedicates a song to ${target.toString()}! 🎶\n\n` +
                `🎼 **Song:** ${remaining}\n\n` +
                `*May this song fill your heart with warmth and love* 💖`)
                .setColor(COLORS.default)
                .setThumbnail(target.displayAvatarURL())
