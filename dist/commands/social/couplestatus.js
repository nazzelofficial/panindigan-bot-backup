...
export class CoupleStatusCommand extends BaseCommand {
    constructor() {
        super({ name: 'couplestatus', description: 'Check if you\'re single, have a pending request, or are in a couple 💭', category: 'social', premiumTier: 'free', cooldown: 3, guildOnly: true, slashCommand: true, prefixCommand: true, aliases: ['relationshipstatus', 'rs'], examples: ['/couplestatus', 'p!couplestatus'] });
    }
    buildSlashCommand() {
