...
export class LoveLetterCommand extends BaseCommand {
    ...
    buildSlashCommand() {
        return (new SlashCommandBuilder()
            ...
            .addUserOption(o => o.setName('user').setDescription('Who to send the love letter to').setRequired(true))
            .addStringOption(o => o.setName('message').setDescription('Add a personal touch to your letter (optional)').setRequired(false))
            .setDMPermission(true));
    }
    buildLetter(sender, recipient, personal) {
