...
export class StareCommand extends BaseCommand {
    constructor() {
        super({ name: 'stare', description: 'Stare intensely at someone! 👀', category: 'social', premiumTier: 'free', cooldown: 3, guildOnly: false, slashCommand: true, prefixCommand: true, aliases: ['glare', 'gaze'], examples: ['/stare @user', 'p!stare @user'] });
    }
    buildSlashCommand() {
    ...
    async executePrefix(m, _args) {
        ...
        if (!t) {
            await m.reply('❌ Mention someone to stare at!');
            return;
        }
