...
export class BioCommand extends BaseCommand {
    ...
    buildSlashCommand() {
        return (new SlashCommandBuilder()
            ...
            .addStringOption(o => o.setName('text').setDescription('Your new bio (max 200 characters)').setRequired(true).setMaxLength(200)))
            .addSubcommand(sub => sub
            .setName('view')
            .setDescription("View a user's bio")
            .addUserOption(o => o.setName('user').setDescription('User to view bio of').setRequired(false)))
