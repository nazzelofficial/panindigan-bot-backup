...
export class DanceCommand extends BaseCommand {
    constructor() {
        super({ name: 'dance', description: 'Dance alone or with someone! 💃', category: 'social', premiumTier: 'free', cooldown: 3, guildOnly: false, slashCommand: true, prefixCommand: true, aliases: ['groove', 'boogie'], examples: ['/dance', '/dance @user', 'p!dance', 'p!dance @user'] });
    }
    buildSlashCommand() {
