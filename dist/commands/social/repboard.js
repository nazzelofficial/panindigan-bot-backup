...
export class RepboardCommand extends BaseCommand {
    constructor() {
        super({ name: 'repboard', description: 'View the reputation leaderboard', category: 'social', premiumTier: 'silver', cooldown: 10, guildOnly: true, slashCommand: true, prefixCommand: true, aliases: ['repleaderboard', 'repl'], examples: ['/repboard', 'p!repboard'] });
    }
    buildSlashCommand() { return (new SlashCommandBuilder().setName(this.name).setDescription(this.description).setDMPermission(false)); }
