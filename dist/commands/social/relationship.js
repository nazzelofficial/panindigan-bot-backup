    ...
    async handlePropose(i) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: '💍 Status', value: 'Pending acceptance', inline: true }, { name: '📅 Proposed', value: `<t:${Math.floor(Date.now() / 1000)}:R>`, inline: true })
                .setTimestamp();
    ...
    async handleAccept(i) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: '💑 Status', value: 'Married', inline: true }, { name: '📅 Married Since', value: `<t:${Math.floor(Date.now() / 1000)}:R>`, inline: true })
                .setTimestamp();
            await i.editReply({ embeds: [embed] });
        }
        catch (error) {
    ...
    async handleInfo(i) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: '👤 Partner', value: partner?.tag || partnerId, inline: true }, { name: '💍 Status', value: relationship.status, inline: true }, { name: '📅 Since', value: relationship.acceptedAt ? `<t:${Math.floor(relationship.acceptedAt.getTime() / 1000)}:R>` : 'N/A', inline: true }, { name: '💕 Nickname', value: relationship.nickname || 'None', inline: true })
                .setTimestamp();
            await i.editReply({ embeds: [embed] });
        }
        catch (error) {
    ...
    async handleAnniversary(i) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: '📅 Marriage Date', value: `<t:${Math.floor(relationship.acceptedAt.getTime() / 1000)}:D>`, inline: true }, { name: '🎊 Next Anniversary', value: `<t:${Math.floor(relationship.acceptedAt.getTime() / 1000) + 31536000}:R>`, inline: true })
                .setTimestamp();
            await i.editReply({ embeds: [embed] });
        }
        catch (error) {
    ...
    async handleCard(i) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: '👤 Partner', value: partner?.tag || partnerId, inline: true }, { name: '💕 Nickname', value: relationship.nickname || 'None', inline: true }, { name: '📅 Married For', value: `${days} days`, inline: true }, { name: '🎯 Goals', value: relationship.goals || 'None', inline: false })
                .setTimestamp();
            await i.editReply({ embeds: [embed] });
        }
        catch (error) {
    ...
    async handleStats(i) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setColor(COLORS.info)
                .addFields({ name: '💑 Status', value: relationship.status, inline: true }, { name: '📅 Days Together', value: `${days}`, inline: true }, { name: '💬 Messages', value: `${messages}`, inline: true }, { name: '🎯 Goals Set', value: relationship.goals ? 'Yes' : 'No', inline: true }, { name: '💕 Nickname', value: relationship.nickname || 'None', inline: true })
                .setTimestamp();
            await i.editReply({ embeds: [embed] });
        }
        catch (error) {
