...
export class AnniversaryCommand extends BaseCommand {
    ...
    buildSlashCommand() {
        return (new SlashCommandBuilder()
            ...
            .addStringOption(o => o.setName('date').setDescription('Anniversary date (YYYY-MM-DD)').setRequired(true)))
            .addSubcommand(sub => sub.setName('check').setDescription('Check your anniversary date'))
