...
export class VisionCommand extends BaseCommand {
    ...
    buildSlashCommand() {
        return new SlashCommandBuilder()
            ...
            .addStringOption(o => o.setName('prompt').setDescription('Optional question about the image').setRequired(false).setMaxLength(500))
    ...
    async executeSlash(i) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: '❓ Question', value: userPrompt, inline: false }, { name: '🤖 AI Analysis', value: response.content.slice(0, 3800) || 'No analysis returned.', inline: false })
    ...
    async executePrefix(m, _args) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setColor(COLORS.gold)
                .setImage(attachment.url)
                .addFields({ name: '❓ Question', value: userPrompt, inline: false }, { name: '🤖 AI Analysis', value: response.content.slice(0, 3800), inline: false })
