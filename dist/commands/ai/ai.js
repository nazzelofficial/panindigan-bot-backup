...
import { SlashCommandBuilder, ModalBuilder, TextInputBuilder, TextInputStyle, } from 'discord.js';
...
export class AICommand extends BaseCommand {
    ...
    async executeSlash(i) {
        ...
        if (subcommandGroup === 'chat') {
            ...
            switch (subcommand) {
                case 'text':
                    await this.handleGenerateText(i);
                    break;
                case 'image':
                    await this.handleGenerateImage(i);
                    break;
                case 'code':
                    await this.handleGenerateCode(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'text':
                    await this.handleAnalyzeText(i);
                    break;
                case 'sentiment':
                    await this.handleSentiment(i);
                    break;
                case 'summarize':
                    await this.handleSummarize(i);
                    break;
                case 'explain':
                    await this.handleExplain(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'translate':
                    ...
                    break;
                case 'rewrite':
                    await this.handleRewrite(i);
                    break;
                case 'improve':
                    await this.handleImprove(i);
                    break;
                case 'factcheck':
                    await this.handleFactCheck(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'generate':
                    await this.handleCodeGenerate(i);
                    break;
                case 'review':
                    await this.handleCodeReview(i);
                    break;
                case 'debug':
                    await this.handleCodeDebug(i);
                    break;
                case 'optimize':
                    await this.handleCodeOptimize(i);
                    break;
                case 'explain':
                    await this.handleCodeExplain(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'describe':
                    await this.handleVisionDescribe(i);
                    break;
                case 'ocr':
                    await this.handleVisionOCR(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'analyze':
                    await this.handleSecurityAnalyze(i);
                    break;
                case 'audit':
                    await this.handleSecurityAudit(i);
                    break;
                default:
