...
export class ConvertCommand extends BaseCommand {
    ...
    buildSlashCommand() {
        return new SlashCommandBuilder()
            ...
            .addStringOption(opt => opt.setName('to').setDescription('To unit (e.g. mi, lb, fahrenheit)').setRequired(true));
    }
    convert(value, from, to) {
        ...
        return new EmbedBuilder()
            ...
            .addFields({ name: 'Input', value: `\`${value} ${from}\``, inline: true }, { name: 'Result', value: `\`${parseFloat(result.toFixed(6))} ${conversion.label}\``, inline: true })
            .setTimestamp();
    }
