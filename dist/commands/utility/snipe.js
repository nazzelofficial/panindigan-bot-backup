    ...
    async getSnipe(channelId) {
        try {
            ...
            return new EmbedBuilder()
                ...
                .addFields({ name: 'Author', value: data.author ?? 'Unknown', inline: true }, { name: 'Deleted At', value: `<t:${Math.floor(deletedAt.getTime() / 1000)}:R>`, inline: true })
                .setTimestamp();
        }
        catch (err) {
