...
export class GoogleCommand extends BaseCommand {
    ...
    buildEmbed(query) {
        ...
        return new EmbedBuilder()
            ...
            .setDescription(`🔗 **[Click to search Google](${googleUrl})**\n\n` +
            `**Related searches:**\n` +
            ...
            .addFields({ name: '🔗 Direct Link', value: `[Open in Google](${googleUrl})`, inline: true }, { name: '🦆 Alternative', value: `[DuckDuckGo](https://duckduckgo.com/?q=${encoded})`, inline: true }, { name: '📚 Wikipedia', value: `[Search Wiki](https://en.wikipedia.org/w/index.php?search=${encoded})`, inline: true })
