...
export class CaptionCommand extends BaseCommand {
    constructor() {
        super({ name: 'caption', description: 'Add a caption to a user\'s avatar', category: 'image', premiumTier: 'free', cooldown: 5, guildOnly: false, slashCommand: true, prefixCommand: true, aliases: ['addcaption', 'captionify'], examples: ['/caption @user "Hello World"', 'p!caption @user Hello World'] });
    }
    buildSlashCommand() {
