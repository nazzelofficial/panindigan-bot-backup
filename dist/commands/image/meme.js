...
export class MemeCommand extends BaseCommand {
    constructor() {
        super({ name: 'meme', description: 'Get a random meme from Reddit', category: 'image', premiumTier: 'free', cooldown: 5, guildOnly: false, slashCommand: true, prefixCommand: true, aliases: ['randommeme', 'getmeme'], examples: ['/meme', 'p!meme'] });
    }
    async executeSlash(i) {
        ...
        try {
            ...
            await i.editReply({ content: `❌ ${e.message || 'Failed to fetch meme.'}` });
        }
    }
