...
export class TrashCommand extends BaseCommand {
    constructor() {
        super({ name: 'trash', description: 'Put a user\'s avatar in a trash can', category: 'image', premiumTier: 'free', cooldown: 5, guildOnly: false, slashCommand: true, prefixCommand: true, aliases: ['garbage', 'rubbish'], examples: ['/trash @user', 'p!trash @user'] });
    }
    buildSlashCommand() {
