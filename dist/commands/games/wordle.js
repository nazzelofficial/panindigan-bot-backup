...
export class WordleCommand extends BaseCommand {
    ...
    words = ['apple', 'beach', 'chair', 'dance', 'eagle', 'flame', 'grape', 'house', 'image', 'jolly', 'knife', 'lemon', 'money', 'night', 'ocean', 'piano', 'quiet', 'radio', 'snake', 'tiger', 'unity', 'video', 'water', 'xenon', 'yacht', 'zebra'];
