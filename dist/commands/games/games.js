...
export class GamesCommand extends BaseCommand {
    ...
    async executeSlash(i) {
        ...
        if (subcommandGroup === '2player') {
            switch (subcommand) {
                case 'tictactoe':
                    await this.handleTicTacToe(i);
                    break;
                case 'connect4':
                    await this.handleConnect4(i);
                    break;
                case 'battleship':
                    await this.handleBattleship(i);
                    break;
                case 'chess':
                    await this.handleChess(i);
                    break;
                case 'rps':
                    await this.handleRPS(i);
                    break;
                case 'rpsls':
                    await this.handleRPSLS(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case '2048':
                    await this.handle2048(i);
                    break;
                case 'snake':
                    await this.handleSnake(i);
                    break;
                case 'minesweeper':
                    await this.handleMinesweeper(i);
                    break;
                case 'sudoku':
                    await this.handleSudoku(i);
                    break;
                case 'wordle':
                    await this.handleWordle(i);
                    break;
                case 'wordsearch':
                    await this.handleWordSearch(i);
                    break;
                case 'memory':
                    await this.handleMemory(i);
                    break;
                case 'simonsays':
                    await this.handleSimonSays(i);
                    break;
                case 'reaction':
                    await this.handleReaction(i);
                    break;
                case 'typing':
                    await this.handleTyping(i);
                    break;
                case 'whackamole':
                    await this.handleWhackAMole(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'blackjack':
                    await this.handleBlackjack(i);
                    break;
                case 'roulette':
                    await this.handleRoulette(i);
                    break;
                case 'slots':
                    await this.handleSlots(i);
                    break;
                case 'poker':
                    await this.handlePoker(i);
                    break;
                case 'higherlower':
                    await this.handleHigherLower(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'trivia':
                    await this.handleTrivia(i);
                    break;
                case 'akinator':
                    await this.handleAkinator(i);
                    break;
                case 'hangman':
                    await this.handleHangman(i);
                    break;
            }
        }
            ...
            switch (subcommand) {
                case 'adventure':
                    await this.handleAdventure(i);
                    break;
                case 'character':
                    await this.handleCharacter(i);
                    break;
                case 'inventory':
                    await this.handleInventory(i);
                    break;
                case 'battle':
                    await this.handleBattle(i);
                    break;
                default:
    ...
    // 2-Player Games
    async handleTicTacToe(i) {
        await i.deferReply();
        const opponent = i.options.getUser('opponent', true);
        try {
            const row = new ActionRowBuilder()
                .addComponents(new ButtonBuilder().setCustomId('ttt_0').setLabel(' ').setStyle(ButtonStyle.Secondary), new ButtonBuilder().setCustomId('ttt_1').setLabel(' ').setStyle(ButtonStyle.Secondary), new ButtonBuilder().setCustomId('ttt_2').setLabel(' ').setStyle(ButtonStyle.Secondary))
                .addComponents(new ButtonBuilder().setCustomId('ttt_3').setLabel(' ').setStyle(ButtonStyle.Secondary), new ButtonBuilder().setCustomId('ttt_4').setLabel(' ').setStyle(ButtonStyle.Secondary), new ButtonBuilder().setCustomId('ttt_5').setLabel(' ').setStyle(ButtonStyle.Secondary))
                .addComponents(new ButtonBuilder().setCustomId('ttt_6').setLabel(' ').setStyle(ButtonStyle.Secondary), new ButtonBuilder().setCustomId('ttt_7').setLabel(' ').setStyle(ButtonStyle.Secondary), new ButtonBuilder().setCustomId('ttt_8').setLabel(' ').setStyle(ButtonStyle.Secondary));
