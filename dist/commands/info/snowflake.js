...
export class SnowflakeCommand extends BaseCommand {
    ...
    buildSlashCommand() {
        return (new SlashCommandBuilder()
            ...
            .addStringOption(o => o.setName('id').setDescription('The Discord snowflake ID to decode').setRequired(true)));
    }
    buildEmbed(id) {
        ...
        return new EmbedBuilder()
            ...
            .addFields({ name: '❄️ Snowflake ID', value: `\`${id}\``, inline: false }, { name: '📅 Created At', value: `<t:${unixSec}:F> (<t:${unixSec}:R>)`, inline: false }, { name: '🕐 Unix Timestamp', value: `\`${timestamp.getTime()}\` ms`, inline: true }, { name: '🔧 Worker ID', value: `\`${workerId}\``, inline: true }, { name: '⚙️ Process ID', value: `\`${processId}\``, inline: true }, { name: '🔢 Increment', value: `\`${increment}\``, inline: true })
