...
export class GrowthStatsCommand extends BaseCommand {
    ...
    async executeSlash(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({ name: '👥 Total Members', value: `**${guild.memberCount.toLocaleString()}**`, inline: true }, { name: '📅 Server Age', value: `**${ageDays}** days`, inline: true }, { name: '📈 Avg Growth', value: `**${avgPerDay}** members/day`, inline: true }, { name: '📥 New Members', value: `Today: **${joinedToday}**\nThis week: **${joinedWeek}**\nThis month: **${joinedMonth}**`, inline: true }, {
            name: '🆕 Recent Joins',
    ...
    async executePrefix(message, _args) {
        ...
        const embed = new EmbedBuilder()
            .setTitle(`📊 Growth Stats — ${guild.name}`)
            .setColor(COLORS.success)
            .addFields({ name: '👥 Total Members', value: `**${guild.memberCount.toLocaleString()}**`, inline: true }, { name: '📅 Age', value: `**${ageDays}** days`, inline: true }, { name: '📈 Avg', value: `**${ageDays > 0 ? (guild.memberCount / ageDays).toFixed(2) : 'N/A'}**/day`, inline: true })
            .setTimestamp();
