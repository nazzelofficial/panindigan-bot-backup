    ...
    async executePrefix(m, _args) {
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: 'ID', value: guild.id, inline: true }, { name: 'Owner', value: ownerTag, inline: true }, { name: 'Members', value: `${guild.memberCount}`, inline: true }, { name: 'Channels', value: `${guild.channels.cache.size}`, inline: true }, { name: 'Roles', value: `${guild.roles.cache.size}`, inline: true }, { name: 'Premium Tier', value: `${guild.premiumTier}`, inline: true }, { name: 'Boosts', value: `${guild.premiumSubscriptionCount ?? 0}`, inline: true }, { name: 'Emojis', value: `${guild.emojis.cache.size}`, inline: true }, { name: 'Created', value: createdAt, inline: false })
                .setTimestamp();
