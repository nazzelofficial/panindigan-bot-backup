...
export class SetMuteRoleCommand extends BaseCommand {
    constructor() {
        const options = {
            name: 'setmuterole',
            ...
            slashCommand: true,
            prefixCommand: true,
            aliases: ['muterole', 'setmuted'],
            examples: ['/setmuterole @Muted', 'p!setmuterole @Muted'],
        };
        super(options);
    }
    async executeSlash(interaction) {
        ...
        const embed = new EmbedBuilder()
            .setTitle(`${EMOJIS.success} Mute Role Set`)
...
export default SetMuteRoleCommand;
