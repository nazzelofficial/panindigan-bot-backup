...
export class XpbattleCommand extends BaseCommand {
    ...
    buildSlashCommand() {
        return (new SlashCommandBuilder()
            ...
            .addStringOption(o => o.setName('duration').setDescription('Duration of the event (e.g. 1h, 30m, 2h30m)').setRequired(true))
    ...
    async startEvent(guildId, durationSeconds) {
        await connectRedis();
    ...
    buildEmbed(durationStr, durationSeconds) {
        ...
        return new EmbedBuilder()
            ...
            .addFields({ name: '⏱️ Duration', value: this.formatDuration(durationSeconds), inline: true }, { name: '🔢 Multiplier', value: '2x XP', inline: true }, { name: '🕐 Ends At', value: `<t:${Math.floor(endTime.getTime() / 1000)}:F>`, inline: false })
