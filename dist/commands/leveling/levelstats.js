    ...
    async executeSlash(interaction) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: '👥 Users with XP', value: totalUsers.toLocaleString(), inline: true }, { name: '✨ Total XP Given', value: totalXpGiven.toLocaleString(), inline: true }, { name: '🏆 Highest Level User', value: topUserStr, inline: false })
