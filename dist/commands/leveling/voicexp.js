        ...
        try {
            if (sub === 'enable') {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .addFields({ name: 'Status', value: guild?.voiceXpEnabled ? '✅ Enabled' : '❌ Disabled', inline: true }, { name: 'XP Rate', value: '5 XP per minute (configured in bot settings)', inline: true })
                    .setTimestamp();
        ...
        try {
            if (sub === 'enable') {
                ...
                const embed = new EmbedBuilder()
                    .setTitle('🎙️ Voice XP Configuration')
                    .setColor(COLORS.default)
                    .addFields({ name: 'Status', value: guild?.voiceXpEnabled ? '✅ Enabled' : '❌ Disabled', inline: true }, { name: 'XP Rate', value: '5 XP per minute', inline: true })
