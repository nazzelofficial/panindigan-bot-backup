...
// ─── Base Modal Builder ────────────────────────────────────────────────────────────
function baseModal(customId, title, inputs) {
...
// ─── AI Prompt Modal ───────────────────────────────────────────────────────────────
export function aiPromptModal(customId, prompt) {
...
// ─── Translate Modal ──────────────────────────────────────────────────────────────
export function translateModal(customId) {
...
// ─── Rewrite Modal ────────────────────────────────────────────────────────────────
export function rewriteModal(customId, text) {
...
// ─── Summarize Modal ─────────────────────────────────────────────────────────────
export function summarizeModal(customId, text) {
...
// ─── Announcement Modal ─────────────────────────────────────────────────────────────
export function announcementModal(customId) {
...
// ─── Warn Modal ───────────────────────────────────────────────────────────────────
export function warnModal(customId, reason) {
...
// ─── Ban Modal ────────────────────────────────────────────────────────────────────
export function banModal(customId, reason, deleteDays) {
...
// ─── Timeout Modal ─────────────────────────────────────────────────────────────────
export function timeoutModal(customId, reason, duration) {
...
// ─── Nickname Modal ──────────────────────────────────────────────────────────────
export function nicknameModal(customId, currentNickname) {
...
// ─── Embed Builder Modal ───────────────────────────────────────────────────────────
export function embedBuilderModal(customId) {
...
// ─── Music Search Modal ───────────────────────────────────────────────────────────
export function musicSearchModal(customId, query) {
...
// ─── Playlist URL Modal ────────────────────────────────────────────────────────────
export function playlistUrlModal(customId) {
...
// ─── Seek Modal ───────────────────────────────────────────────────────────────────
export function seekModal(customId) {
...
// ─── Jump Modal ───────────────────────────────────────────────────────────────────
export function jumpModal(customId) {
...
// ─── Volume Modal ──────────────────────────────────────────────────────────────────
export function volumeModal(customId, currentVolume) {
...
// ─── Reminder Modal ───────────────────────────────────────────────────────────────
export function reminderModal(customId) {
...
// ─── Poll Modal ───────────────────────────────────────────────────────────────────
export function pollModal(customId) {
...
// ─── Suggestion Modal ─────────────────────────────────────────────────────────────
export function suggestionModal(customId) {
...
// ─── Ticket Reason Modal ─────────────────────────────────────────────────────────
export function ticketReasonModal(customId) {
...
export function welcomeMessageModal(customId, currentMessage) {
...
export function goodbyeMessageModal(customId, currentMessage) {
...
// ─── Verification Modal ────────────────────────────────────────────────────────────
export function verificationModal(customId) {
...
// ─── Reaction Role Modal ───────────────────────────────────────────────────────────
export function reactionRoleModal(customId) {
...
// ─── Premium Setup Modal ───────────────────────────────────────────────────────────
export function premiumSetupModal(customId) {
...
export function webhookMessageModal(customId) {
...
// ─── Auto Role Modal ──────────────────────────────────────────────────────────────
export function autoRoleModal(customId) {
...
// ─── Logging Modal ─────────────────────────────────────────────────────────────────
export function loggingModal(customId) {
...
export function serverConfigModal(customId) {
