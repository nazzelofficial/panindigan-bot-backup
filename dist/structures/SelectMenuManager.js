 ...
 * ═══════════════════════════════════════════════════
 */
import { ActionRowBuilder, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, RoleSelectMenuBuilder, UserSelectMenuBuilder, ChannelSelectMenuBuilder, MentionableSelectMenuBuilder, } from 'discord.js';
// ─── String Select Menu Builder ────────────────────────────────────────────────────
export function stringSelectMenu(customId, placeholder, options, config = {}) {
    ...
    const menu = new StringSelectMenuBuilder()
        ...
        if (opt.default)
            option.setDefault(opt.default);
        return option;
    }));
    return new ActionRowBuilder().addComponents(menu);
}
// ─── Role Select Menu Builder ─────────────────────────────────────────────────────
export function roleSelectMenu(customId, placeholder, config = {}) {
...
export function userSelectMenu(customId, placeholder, config = {}) {
...
export function channelSelectMenu(customId, placeholder, config = {}) {
    const { minValues = 1, maxValues = 1, disabled = false, channelTypes = [], defaultChannels = [], } = config;
...
export function mentionableSelectMenu(customId, placeholder, config = {}) {
    const { minValues = 1, maxValues = 1, disabled = false, defaultUsers = [], defaultRoles = [], } = config;
...
export function categorySelectMenu(customId, categories) {
    return stringSelectMenu(customId, 'Select a category', categories.map(cat => ({
        label: cat.name,
        value: cat.value,
...
export function musicSourceSelectMenu(customId) {
    return stringSelectMenu(customId, 'Select music source', [
...
export function languageSelectMenu(customId) {
    return stringSelectMenu(customId, 'Select language', [
...
export function premiumTierSelectMenu(customId) {
    return stringSelectMenu(customId, 'Select premium tier', [
...
export function timezoneSelectMenu(customId) {
    return stringSelectMenu(customId, 'Select timezone', [
...
export function queueActionSelectMenu(customId) {
    return stringSelectMenu(customId, 'Select queue action', [
...
export function moderationActionSelectMenu(customId) {
    return stringSelectMenu(customId, 'Select moderation action', [
...
export function aiModelSelectMenu(customId) {
    return stringSelectMenu(customId, 'Select AI model', [
...
export function helpCategorySelectMenu(customId) {
    return stringSelectMenu(customId, 'Select a category', [
...
export function sortOrderSelectMenu(customId) {
    return stringSelectMenu(customId, 'Select sort order', [
...
export function paginationSizeSelectMenu(customId) {
    return stringSelectMenu(customId, 'Select items per page', [
...
// ─── Export Select Menu ─────────────────────────────────────────────────────────────
export function exportSelectMenu(customId) {
    return stringSelectMenu(customId, 'Select export format', [
...
export function customSelectMenu(customId, placeholder, options, config) {
    return stringSelectMenu(customId, placeholder, options, config);
}
// ─── Helper to get selected values from interaction ─────────────────────────────────
export function getSelectedValues(interaction) {
...
//# sourceMappingURL=SelectMenuManager.js.map