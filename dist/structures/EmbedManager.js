 ...
 */
export function buildProgressBar(value, max, length = 12) {
...
// ─── Loading Embed ───────────────────────────────────────────────────────────────
export function loadingEmbed(action, description, options = {}) {
    return baseEmbed(EMBED_COLORS.info, {
...
// ─── Confirmation Embed ───────────────────────────────────────────────────────────
export function confirmationEmbed(title, description, options = {}) {
    return baseEmbed(EMBED_COLORS.warning, {
        title: `${EMBED_ICONS.warning} ${title}`,
...
// ─── AI Embed ─────────────────────────────────────────────────────────────────────
export function aiEmbed(title, description, options = {}) {
...
// ─── Music Embed ──────────────────────────────────────────────────────────────────
export function musicEmbed(title, description, options = {}) {
...
// ─── Queue Embed ─────────────────────────────────────────────────────────────────
export function queueEmbed(title, description, options = {}) {
    return baseEmbed(EMBED_COLORS.music, {
...
// ─── Premium Embed ───────────────────────────────────────────────────────────────
export function premiumEmbed(title, description, tier, options = {}) {
    const tierEmojis = {
...
// ─── Utility Embed ────────────────────────────────────────────────────────────────
export function utilityEmbed(title, description, options = {}) {
...
// ─── Economy Embed ───────────────────────────────────────────────────────────────
export function economyEmbed(title, description, options = {}) {
...
// ─── Logging Embed ───────────────────────────────────────────────────────────────
export function loggingEmbed(title, description, options = {}) {
...
// ─── Configuration Embed ─────────────────────────────────────────────────────────
export function configurationEmbed(title, description, options = {}) {
...
// ─── Dashboard Embed ─────────────────────────────────────────────────────────────
export function dashboardEmbed(title, description, options = {}) {
...
// ─── User Embed ───────────────────────────────────────────────────────────────────
export function userEmbed(title, user, description, options = {}) {
...
// ─── Server Embed ────────────────────────────────────────────────────────────────
export function serverEmbed(title, guild, description, options = {}) {
    return baseEmbed(EMBED_COLORS.primary, {
...
// ─── Role Embed ──────────────────────────────────────────────────────────────────
export function roleEmbed(title, description, options = {}) {
...
// ─── Channel Embed ───────────────────────────────────────────────────────────────
export function channelEmbed(title, description, options = {}) {
...
// ─── Ticket Embed ────────────────────────────────────────────────────────────────
export function ticketEmbed(title, description, options = {}) {
...
// ─── Giveaway Embed ───────────────────────────────────────────────────────────────
export function giveawayEmbed(title, description, options = {}) {
...
// ─── Poll Embed ───────────────────────────────────────────────────────────────────
export function pollEmbed(title, description, options = {}) {
...
// ─── Reminder Embed ───────────────────────────────────────────────────────────────
export function reminderEmbed(title, description, options = {}) {
...
// ─── Statistics Embed ─────────────────────────────────────────────────────────────
export function statisticsEmbed(title, description, options = {}) {
...
// ─── Analytics Embed ──────────────────────────────────────────────────────────────
export function analyticsEmbed(title, description, options = {}) {
...
// ─── Search Result Embed ──────────────────────────────────────────────────────────
export function searchResultEmbed(title, description, options = {}) {
...
// ─── Leveling Embed ───────────────────────────────────────────────────────────────
export function levelingEmbed(title, description, options = {}) {
...
// ─── Admin Embed ──────────────────────────────────────────────────────────────────
export function adminEmbed(title, description, options = {}) {
...
// ─── Games Embed ─────────────────────────────────────────────────────────────────
export function gamesEmbed(title, description, options = {}) {
...
// ─── Social Embed ────────────────────────────────────────────────────────────────
export function socialEmbed(title, description, options = {}) {
...
// ─── Custom Embed ────────────────────────────────────────────────────────────────
export function customEmbed(color, title, description, options = {}) {
    return baseEmbed(color, { title, description, ...options });
}
// ─── Moderation Action Embed ──────────────────────────────────────────────────────
export function moderationActionEmbed(action, target, moderator, reason, caseId, duration) {
    const actionEmojis = {
...
export function nowPlayingEmbed(opts) {
    ...
    if (author)
        fields.push({ name: '🎤 Artist', value: author, inline: true });
    if (requester)
        fields.push({ name: '👤 Requested', value: `<@${requester}>`, inline: true });
    if (volume !== undefined)
        fields.push({ name: `${volEmoji} Volume`, value: `${volume}%`, inline: true });
    if (loop !== undefined)
        fields.push({ name: `${loopEmoji} Loop`, value: loop ?? 'none', inline: true });
    return baseEmbed(EMBED_COLORS.music, {
        title: `🎵 ${title}`,
        url: uri,
        thumbnail,
...
//# sourceMappingURL=EmbedManager.js.map