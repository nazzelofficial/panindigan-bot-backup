...
export const event = {
    ...
    async execute(reaction, user, client) {
        ...
        try {
            ...
            if (!guildData?.starboardChannelId || guildData.starboardLocked)
                return;
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: 'Channel', value: `<#${reaction.message.channel.id}>`, inline: true }, { name: 'Stars', value: `${starEmoji} ${reactionCount}`, inline: true }, { name: 'Jump', value: `[Click here](${reaction.message.url})`, inline: true })
