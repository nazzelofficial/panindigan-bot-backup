...
export async function getUserPremiumTier(userId, guildId) {
...
export async function getGuildPremiumTier(guildId) {
    const prisma = getPrismaClient();
    try {
...
export async function activatePremiumKey(userId, guildId, key) {
    ...
    try {
        ...
        return { success: true, tier: premiumKey.tier };
    }
    catch (error) {
...
export async function activateFreeTrial(userId, guildId) {
...
export async function hasPremiumAccess(userId, guildId, requiredTier) {
...
export function tierHierarchy(tier) {
    const order = ['free', 'bronze', 'silver', 'gold', 'diamond'];
...
export class PremiumHandler {
    ...
    async getUserPremiumStatus(userId) {
        ...
        try {
            ...
            const tier = (expired ? 'free' : premium.tier);
