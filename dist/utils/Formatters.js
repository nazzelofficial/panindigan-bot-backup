...
export class PermissionFormatter {
     ...
     */
    static isAdministrator(permissions) {
        if (Array.isArray(permissions)) {
     ...
     */
    static isModerator(permissions) {
        if (Array.isArray(permissions)) {
